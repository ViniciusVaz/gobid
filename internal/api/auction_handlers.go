...
import (
	...
	"github.com/ViniciusVaz/gobid/internal/jsonutils"
	"github.com/ViniciusVaz/gobid/internal/services"
...
func (api *Api) handleSubscribeUserToAuction(w http.ResponseWriter, r *http.Request) {
	...
	foundProductId, err := api.ProductService.GetProductById(r.Context(), productId)
	if err != nil {
	...
	room, ok := api.AuctionLobby.Rooms[foundProductId.ID]
